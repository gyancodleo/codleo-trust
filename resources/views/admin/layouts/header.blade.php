...
<body x-data="main" class="relative overflow-x-hidden font-poppins text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
                                            ...
                                            <div class="group flex items-center px-4 py-2" @click.self="toggle">
                                                <div class="grid place-content-center rounded">
                                                    <div class="relative h-12 w-12">
                                                        <img class="h-12 w-12 rounded-full object-cover" :src="`${notification.profile}`" alt="image">
                                ...
                                <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('assets/images/profile.png') }}" alt="image">
                                            </div>
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <a href="javascript:;" class="!py-3 text-danger" @click="toggle">
                                            <form action="{{ route('admin.logout') }}" method="post">
                                                @csrf
                                                <button type="submit">
                                                    <svg class="d-inline h-4.5 w-4.5 shrink-0 rotate-90 ltr:mr-2 rtl:ml-2" style="display: inline;" width="18" height="18" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
